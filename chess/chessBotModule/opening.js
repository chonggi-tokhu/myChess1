(function (ep, gth, module) {
    ...
    var openings = {
        ...
        named: [
            ...
            { name: `King's Pawn Opening`, move: ['e4'], idx: 1, fen: `rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1`, relatedOpenings: { mainline: 3, upper: [0], lower: [3, 5, 7, 9, 10, 11, 12] }, otherNames: [] },
            { name: `Queen's Pawn Opening`, move: ['d4'], idx: 2, fen: `rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq - 0 1`, relatedOpenings: { mainline: 4, upper: [0], lower: [4, 6] }, otherNames: [] },
            { name: `Open Game`, move: ['e4', 'e5'], idx: 3, fen: `rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2`, relatedOpenings: { mainline: 13, lower: [], upper: [1] }, otherNames: [] },
            { name: `Closed game`, move: ['d4', 'd5'], idx: 4, fen: `rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 2`, relatedOpenings: { mainline: 14, upper: [2], lower: [14] }, otherNames: [] },
